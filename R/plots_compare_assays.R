...
#' It can be used for example to compare the effect of the normalization process.
#' 
#' The comparison is made with the division operator.
#'
#' @param assay1 A numeric matrix containing quantitative data before normalization.
#'
#' @param assay2 A numeric matrix containing quantitative data after normalization.
#'
