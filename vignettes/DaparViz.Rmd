...
Thus, in this example, the shiny app called `ds_foo` must provide the functions 
`mod_ds_foo_ui()` and `mod_ds_foo_server()`. 
...
as follows. In the example below, one want to add the app called `mod_external_foo` 
