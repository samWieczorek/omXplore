...
```{r unknown,  message = FALSE, warning = FALSE, echo = TRUE}
library(DaparViz)
FormatAvailables()
```
...
```{r view_dataset, fig.show='hide', message = FALSE, warning = FALSE, echo = TRUE}
library(DaparViz)
data(vData_ft)
...
```{r ex_modules, fig.show='hide', message = FALSE, warning = FALSE, echo = TRUE}
library(DaparViz)
data(vData_ft)
obj <- vData_ft[[1]]
listPlotModules()
...
```{r addons, fig.show='hide', message = FALSE, warning = FALSE, echo = TRUE}
library(DaparViz)
data(vData_ft)
