...
package: DaparViz
abstract: >
    The package DaparViz is a R package which provides functions to vizualize        quantitative data from label-free proteomics experiments. It can deal with
    several data formats such as MSnSet, QFeatures or event simple lists.
    This document covers the functionalities available in 
    `r BiocStyle::pkg_ver('DaparViz')`.
date: "`r Sys.Date()`"
output:
